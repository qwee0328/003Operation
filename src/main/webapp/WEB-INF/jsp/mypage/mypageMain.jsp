	 ...
	 <div class="container">
        <div class="profile">
            <div class="profile__cover">
                <div class="profile__img align-center"><img src="/images/profileImg.png"></div>
                <div class="profile__nickname align-center">닉네임님&nbsp;&nbsp;<i
                        class="fa-solid fa-chevron-right colorGray"></i></div>
                <div class="profile__logoutBtnCover align-center"><button
                        class="profile__logoutBtn bColorWhite">로그아웃</button></div>
            </div>
        </div>

        <div class="mypageMenu">
            <div class="mypageMenu__top d-flex">
                <div class="mypageMenu__topLeft">
                    <div class="topLeft__cover">
                        <div class="mypageMenu__level d-flex">
                            ...
                            <div class="level__txt colorGray">
                                Lv.0
                            </div>
                        </div>
                        ...
                        <div class="mypageMenu__point d-flex">
                            ...
                            <div class="point__txt colorGray">
                                0 P
                            </div>
                        </div>
                    </div>
                ...
                <div class="mypageMenu__topRight">
                    <div class="topRight__cover">
                        ...
                        <div class="title__bottom align-center colorGray">
                            현재 선택한 칭호명
                        </div>
                    </div>
                </div>
                    ...
                    <div class="myActivity__menu">
                        <div class="myActivity__menu1 d-flex">
                            <div class="myActivity__game d-flex">
                                <div class="myActivity__icon"><i class="fa-solid fa-gamepad colorGray"></i></div>
                                <div class="myActivity__txt colorGray">키오스크 게임 이용 내역</div>
                                <div class="myActivity__move"><i class="fa-solid fa-chevron-right colorGray"></i></div>
                            </div>
                            <div class="myActivity__point d-flex">
                                <div class="myActivity__icon"><i class="fa-solid fa-coins colorGray"></i></div>
                        ...
                        <div class="myActivity__menu2 d-flex">
                            <div class="myActivity__game d-flex">
                                <div class="myActivity__icon"><i class="fa-solid fa-file colorGray"></i></div>
                                <div class="myActivity__txt colorGray">작성한 게시글 내역</div>
                                <div class="myActivity__move"><i class="fa-solid fa-chevron-right colorGray"></i></div>
                            </div>
                            <div class="myActivity__point d-flex">
                                <div class="myActivity__icon"><i class="fa-solid fa-bookmark colorGray"></i></div>
                        ...
                        <div class="myActivity__menu3 d-flex">
                            <div class="myActivity__game d-flex">
                                <div class="myActivity__icon"><i class="fa-solid fa-comment-dots colorGray"></i></div>
                    ...
                    <div class="myAsk__menu">
                        <div class="myAsk__menu1 d-flex">
                            <div class="myAsk__qna d-flex">
                                <div class="myAsk__icon"><i class="fa-solid fa-circle-question colorGray"></i></div>
                                <div class="myAsk__txt colorGray">Q&A 문의 내역</div>
                                <div class="myAsk__move"><i class="fa-solid fa-chevron-right colorGray"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="myInfo__menu">
                        <div class="myInfo__menu1 d-flex">
                            <div class="myInfo__setting d-flex">
                                <div class="myInfo__icon"><i class="fa-solid fa-circle-question colorGray"></i></div>
                                <div class="myInfo__txt colorGray">Q&A 문의 내역</div>
                                <div class="myInfo__move"><i class="fa-solid fa-chevron-right colorGray"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
