...
<link rel="stylesheet" href="/css/mypage/myReply.css"/>
<link rel="stylesheet" href="/css/commons/common.css"/>
<script src="/js/mypage/myReply.js"></script>
</head>
<body>
        ...
        <div class="guide">
            <div class="board__header"> 	
            	<div class="mypage__tap d-flex">
            		...
            		<div class="tap__myReply active"><a href="/member/mypage/goMyReply">내가 작성한 댓글</a></div>
            		<div class="tap__myBookmark"><a href="/member/mypage/goMyBookmark">내가 북마크한 글</a></div>
            	</div>
