					...
					<div class="postInfo">
						<div class="postInfo__left">
							...
							<div class="postInfo__userInfo">
								<input type="hidden" value="${post.question.member_nickname }" id="memberNickname"> 
								<input type="hidden" value="${post.question.id }" id="qnaId">
						...
						<div class="answerContents">
							<div class="boardPost__guide">
								...
								<div class="postInfo">
									<div class="postInfo__left">
										<div class="postInfo__profile">
											<img src="/images/profileImg.png" alt="프로필 이미지" id="writer_profile">
										</div>
										<div class="postInfo__userInfo">
